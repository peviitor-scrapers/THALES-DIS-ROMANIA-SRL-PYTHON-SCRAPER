...
3. Verificare: `gh repo view peviitor-scrapers/THALES-DIS-ROMANIA-SRL-PYTHON-SCRAPER --json defaultBranch`
...
gh api repos/peviitor-scrapers/THALES-DIS-ROMANIA-SRL-PYTHON-SCRAPER/git/refs -f ref="refs/heads/main" -f sha=$(gh api repos/peviitor-scrapers/THALES-DIS-ROMANIA-SRL-PYTHON-SCRAPER/git/refs/heads/master --jq '.object.sha')

# Schimbă default branch
gh api repos/peviitor-scrapers/THALES-DIS-ROMANIA-SRL-PYTHON-SCRAPER -X PATCH -f default_branch="main"

# Șterge branch-ul master
gh api repos/peviitor-scrapers/THALES-DIS-ROMANIA-SRL-PYTHON-SCRAPER/git/refs/heads/master -X DELETE
```
