...
```bash
git clone git@github.com:peviitor-scrapers/THALES-DIS-ROMANIA-SRL-PYTHON-SCRAPER.git
cd THALES-DIS-ROMANIA-SRL-PYTHON-SCRAPER
...
[peviitor-scrapers/THALES-DIS-ROMANIA-SRL-PYTHON-SCRAPER/issues](https://github.com/peviitor-scrapers/THALES-DIS-ROMANIA-SRL-PYTHON-SCRAPER/issues).
